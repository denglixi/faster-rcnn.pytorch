...
from model.faster_rcnn.faster_rcnn_hierarchy_casecade import _hierarchyCasecadeFasterRCNN
...
class PreResNet50HierarchyCasecade(_hierarchyCasecadeFasterRCNN):
    ...
    def __init__(self, main_classes, sub_classes, pretrained=False, class_agnostic=False, weight_file=None, fixed_layer=0, casecade_type='add_score', alpha=0.5):
        ...
        _hierarchyCasecadeFasterRCNN.__init__(self, main_classes, sub_classes, class_agnostic, casecade_type, alpha)
