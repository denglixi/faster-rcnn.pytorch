...
from model.faster_rcnn.faster_rcnn_attention_minus import _fasterRCNNAttentionMinus
...
class PreResNet50AttentionMinus(_fasterRCNNAttentionMinus):
    ...
    def __init__(self, classes, pretrained=False, class_agnostic=False, weight_file=None, fixed_layer=0):
        ...
        _fasterRCNNAttentionMinus.__init__(self, classes, class_agnostic)
